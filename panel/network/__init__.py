...
__all__ = ["Adapter", "DEFAULT_HOST_OCTET", "DEFAULT_PREFIX", "Requirement",
           "active", "add", "broken_networks", "choose", "choose_host",
           "ensure", "list_adapters", "local_networks", "network_of",
           "occupied", "preferences", "readiness", "release", "release_all",
           "required_networks", "save_preferences", "select_adapter",
           "state", "sweep_stale"]
